...
@section('content')
    <main>
        ...
        <div class="float-right my-2">
            <a class="btn btn-success" href="{{ url('/admin/user/create') }}"><i class="fas fa-fw fa-plus"></i> Masukkan User
                Baru</a>
        </div>
                ...
                @foreach ($users as $user)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-secondary btn-xs" href="{{ url('/admin/user/' . $user->id . '/edit') }}"><i
