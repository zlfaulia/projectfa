...
@section('content')
    <main>
        ...
        <div class="float-right my-2">
            <a class="btn btn-secondary" href="{{ url('/admin/laporanModal/create') }}"><i class="fas fa-fw fa-plus"></i>
                Masukkan Modal</a>
        </div>
                ...
                @foreach ($bahans as $laporanModal)
                    <tr>
                        ...
                        <td class="text-center d-flex">
                            <a class="btn btn-info btn-sm mr-2" href="{{ route('laporanModal.show', $laporanModal->id) }}"><i
                                    class="fas fa-fw fa-eye"></i> Show</a>

                            <a class="btn btn-primary btn-sm mr-2"
                                href="{{ url('/admin/laporanModal/' . $laporanModal->id . '/edit') }}"><i
