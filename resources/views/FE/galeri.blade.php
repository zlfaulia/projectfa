  ...
  <div class="container">
    ...
    <div class="row isotope-grid">
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri1.jpg" alt="IMG-PRODUCT" />
          ...
          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Halaman Depan Konveksi </a>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri2.jpg" alt="IMG-PRODUCT" />
          ...
          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Tempat Pemotongan Kain </a>
            </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri3.jpg" alt="IMG-PRODUCT" />
          ...
          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Tempat Menjahit </a>
            </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri4.jpg" alt="IMG-PRODUCT" />
          </div>

          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Tempat Berbagai Pola Baju </a>
            </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri5.jpg" alt="IMG-PRODUCT" />
          </div>

          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Tempat Sablon </a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri6.jpg" alt="IMG-PRODUCT" />
          </div>

          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Vintage Inspired Classic </a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri7.jpg" alt="IMG-PRODUCT" />
          </div>

          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Shirt in Stretch Cotton </a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
        ...
        <div class="block2">
          <div class="block2-pic hov-img0">
            <img src="images/galeri8.jpg" alt="IMG-PRODUCT" />
          </div>

          <div class="block2-txt flex-w flex-t p-t-14">
            <div class="block2-txt-child1 flex-col-l">
              <a class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6"> Pieces Metallic Printed </a>
            </div>
          </div>
        </div>
      </div>
