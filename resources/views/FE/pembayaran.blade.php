...
@section('content')
    ...
    <section class="p-lr-15 p-tb-100">
        <form method="post" action="{{ url('/FE/pembayaran/') }}" id="myForm" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="kategori" class="form-pemb" name="metode_pembayaran">Pilih Metode Pembayaran</label>
      ...
      <div id="kategori" class="form-text">contoh : kaos custom, PDH, baju olahraga, kaos polo dan lainnya</div> --}}
       ...
       style="width: 150px;" height="100px;" /> --}}
            ...
            <div class="mb-3 p-t-10">
                ...
                <input class="p-tb-5 p-t-5" name="desain" type="file" id="avatar" name="avatar"
