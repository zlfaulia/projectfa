                    ...
                    <div class="row">
                                ...
                                <div class="wrap-slick3 flex-sb flex-w">
                                    ...
                                    <div class="slick3 gallery-lb">
                                        <div class="item-slick3"
                                            data-thumb="{{ asset('public/gambar_produk/' . $produk->gambar_produk) }}">
                                            <div class="wrap-pic-w pos-relative" style="width:400px; heigth:500px;">
                                                <img style="width:350px; heigth:500px;"
                                                    src="{{ asset('public/gambar_produk/' . $produk->gambar_produk) }} "
                                                    alt="IMG-PRODUCT" />
                        ...
                        <div class="col-md-6 col-lg-5 p-b-30">
                            <div class="p-r-50 p-t-5 p-lr-0-lg">
                                ...
                                <form id="form-beli-sekarang" method="get" action="{{ route('pesan', $produk->id) }}">
                                    <div class="p-t-20">
                                        <div class="mtext-110 cl2 js-name-detail p-b-10">Pilih Pesanan</div>
                                        <select class="form-control select2" name="stok_id" id="stok_id">
                                            <option disabled value>Pilih pesanan</option>
                                            @foreach ($harga as $item)
                                                <option value="{{ $item->id }}">
                                                    {{ $item->ukuran . '-' . $item->variasi . '-' . $item->harga_produk }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="p-t-20">
                                        ...
                                        {{-- <a href="{{ route('pesan', $produk->id) }}"
                                            class="text-left btn btn-block btn-sm mt-3"
                                            style="background-color: rgb(208, 208, 221); border-radius: 8px;">
                                            <span class="mtext-110 cl2 js-name-detail p-b-10">
                                                Beli Sekarang
                                            </span>
                                        </a> --}}
                                        <button type="submit" class="text-left btn btn-block btn-sm mt-3"
                                            style="background-color: rgb(208, 208, 221); border-radius: 8px;">
                                            <span class="mtext-110 cl2 js-name-detail p-b-10">
                                                Beli Sekarang
                                            </span>
                                        </button>
                                        {{-- <a href="{{ route('pesan',$produk->id) }}" class="text-left btn btn-block btn-sm mt-3" style="background-color: rgb(208, 208, 221); border-radius: 8px;">
                                        <span class="mtext-110 cl2 js-name-detail p-b-10">
                                            Beli Sekarang
                                        </span>
                                    </a> --}}
