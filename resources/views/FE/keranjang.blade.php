        ...
        <div class="m-l-25 m-r--38 m-lr-0-xl">
              ...
              <tr class="table_row">
                <td class="column-1">
                  <div class="how-itemcart1">
                    <img src="images/pdh.png" alt="IMG" />
                  </div>
                </td>
                <td class="column-2">PDH (Pakaian Dinas Harian)</td>
                <td class="column-3">Rp150.000</td>
                <td class="column-4">
                ...
                <td class="column-5">Rp150.000</td>
              </tr>

              <tr class="table_row">
                <td class="column-1">
                  <div class="how-itemcart1">
                    <img src="images/kaospolos.png" alt="IMG" />
                  </div>
                </td>
                <td class="column-2">Kaos Polos/td></td>
                <td class="column-3">Rp60.000</td>
                <td class="column-4">
                  <div class="wrap-num-product flex-w m-l-auto m-r-0">
                    <div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
                      <i class="fs-16 zmdi zmdi-minus"></i>
          ...
          <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
            <div class="flex-w flex-m m-r-20 m-tb-5">
              ...
              <div class="flex-c-m stext-101 cl2 size-118 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer m-tb-5">Apply
                coupon</div>
            </div>
