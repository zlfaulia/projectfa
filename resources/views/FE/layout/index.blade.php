        ...
        <div class="w-full">
          ...
          <div class="header-cart-buttons flex-w w-full">
            <a href="shoping-cart.html"
              class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10"> View Cart </a>

            <a href="shoping-cart.html"
              class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10"> Check Out </a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="p-t-40">
        {{-- <div class="flex-c-m flex-w p-b-18">
          ...
          <a href="#" class="m-all-1">
            <img src="{{ asset(" FE/") }}{{ asset('') }}images/icons/icon-pay-02.png" alt="ICON-PAY" />
          </a>

          <a href="#" class="m-all-1">
            <img src="{{ asset(" FE/") }}{{ asset('') }}images/icons/icon-pay-03.png" alt="ICON-PAY" />
          </a>

          <a href="#" class="m-all-1">
            <img src="{{ asset(" FE/") }}{{ asset('') }}images/icons/icon-pay-04.png" alt="ICON-PAY" />
          </a>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-5 p-b-30">
            <div class="p-r-50 p-t-5 p-lr-0-lg">
              ...
              <p class="stext-102 cl3 p-t-23">Nulla eget sem vitae eros pharetra viverra. Nam vitae luctus ligula.
                Mauris consequat ornare feugiat.</p>
